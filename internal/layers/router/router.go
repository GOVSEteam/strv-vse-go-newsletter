...
import (
	...
	"github.com/GOVSEteam/strv-vse-go-newsletter/internal/setup-firebase" // Added for Firestore client
...
func InitializeAndSetupRouter() http.Handler {
	...
	setup_firebase.InitFirebase()
	firestoreClient := setup_firebase.GetFirestoreClient()

...
func TestSubscriberService_SubscribeToNewsletter(t *testing.T) {
	...
	tests := []struct {
		...
		mockSetup        func(mockSubRepo *MockSubscriberRepository, mockNewsRepo *MockNewsletterRepository)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tt.mockSetup(mockSubRepo, mockNewsRepo)

			svc := service.NewSubscriberService(mockSubRepo, mockNewsRepo)
...
func TestSubscriberService_UnsubscribeFromNewsletter(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			mockSubRepo := new(MockSubscriberRepository)
			mockNewsRepo := new(MockNewsletterRepository) // Though not used by Unsubscribe, service has it as dependency
			tt.mockSetup(mockSubRepo, mockNewsRepo)
